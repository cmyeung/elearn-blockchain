...
app.post("/receive-new-block", function (req, res) {
  ...
  if (correctHash && correctIndex) {
    ...
    bitcoin.pendingTractions = [];
    res.json({
      node: "New block receive and accepted.",
      newBlock: newBlock,
    });
  } else {
    res.json({
  ...
  Promise.all(requestPromises).then((blockchains) => {
    ...
    blockchains.forEach((blockchain) => {
      if (blockchain.chain.length > maxChainLength) {
        ...
        newPendingTransactions = blockchain.pendingTractions;
    ...
    if (!newLongestChain || !bitcoin.chainIsValid(newLongestChain)) {
      ...
      bitcoin.pendingTractions = newPendingTransactions;
      res.json({
